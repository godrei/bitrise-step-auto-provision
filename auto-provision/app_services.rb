...
def sync_app_services(app, entitlements)
  ...
  if entitlements['com.apple.developer.in-app-payments']
    ...
    app.update_service(Spaceship::Portal.app_service.apple_pay.off)
  end
  ...
  if entitlements['com.apple.developer.associated-domains']
    ...
    app.update_service(Spaceship::Portal.app_service.associated_domains.off)
  end
  ...
  if data_protection_value
    ...
    app.update_service(Spaceship::Portal.app_service.data_protection.off)
  end
  ...
  if entitlements['com.apple.developer.healthkit']
    ...
    app.update_service(Spaceship::Portal.app_service.health_kit.off)
  end
  ...
  if entitlements['com.apple.developer.networking.HotspotConfiguration']
    ...
    app.update_service(Spaceship::Portal.app_service.hotspot.off)
  end
  ...
  if icould_container_value.nil? && icloud_kvs_value.nil? && icould_services_value.nil?
    puts 'set icloud: off'
    app.update_service(Spaceship::Portal.app_service.icloud.off)
  end
  ...
  if entitlements['com.apple.InAppPurchase']
    ...
    app.update_service(Spaceship::Portal.app_service.in_app_purchase.off)
  end
  ...
  if entitlements['inter-app-audio']
    ...
    app.update_service(Spaceship::Portal.app_service.inter_app_audio.off)
  end
  ...
  if entitlements['com.apple.developer.networking.multipath']
    ...
    app.update_service(Spaceship::Portal.app_service.multipath.off)
  end
  ...
  if entitlements['com.apple.developer.networking.networkextension']
    ...
    app.update_service(Spaceship::Portal.app_service.network_extension.off)
  end
  ...
  if entitlements['com.apple.developer.nfc.readersession.formats']
    ...
    app.update_service(Spaceship::Portal.app_service.nfc_tag_reading.off)
  end
  ...
  if entitlements['com.apple.developer.networking.vpn.api']
    ...
    app.update_service(Spaceship::Portal.app_service.vpn_configuration.off)
  end
  ...
  if entitlements['com.apple.external-accessory.wireless-configuration']
    ...
    app.update_service(Spaceship::Portal.app_service.wireless_accessory.off)
  end
end
